    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          const CnTextField(label: 'Food name / title'),
          const SizedBox(height: 16),
          const CnTextField(label: 'Original price (RWF)', keyboardType: TextInputType.number),
          const SizedBox(height: 16),
          const CnTextField(label: 'Discounted price (RWF)', keyboardType: TextInputType.number),
          const SizedBox(height: 16),
          const CnTextField(label: 'Quantity available', keyboardType: TextInputType.number),
          const SizedBox(height: 16),
          const CnTextField(label: 'Description (allergens, freshness)', maxLines: 3),
