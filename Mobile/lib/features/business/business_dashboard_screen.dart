    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            const Text('Business Hub', style: TextStyle(fontWeight: FontWeight.w800, color: AppColors.textPrimary, fontSize: 18)),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Add Business', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(business.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white)),
                        Text(business.type ?? '', style: const TextStyle(fontSize: 12, color: Colors.white70)),
                      ],
                    ),
                  ),
