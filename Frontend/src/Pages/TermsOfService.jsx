    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          {/* For Consumers */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Terms for Consumers</h2>
            <h3 className="text-xl font-medium text-gray-800 mb-3">5.1 Ordering Food</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">6.2 Listing Responsibilities</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
