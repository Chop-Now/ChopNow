  ...
  return (
    <>
        ...
        <div className="min-h-screen w-full bg-white px-6 md:px-16 lg:px-24 xl:px-32 py-12">
            ...
            >
                <h1 className="text-3xl md:text-4xl font-semibold text-slate-800 mt-2">Get in touch with us</h1>
                <p className="text-sm text-slate-500 text-center mt-4 max-w-xl">Have questions about ChopNow? We'd love to hear from you.<br />Send us a message and we'll respond as soon as possible.</p>
            ...
            >
                <div className="flex flex-col md:flex-row items-start gap-6 w-full">
                    <div className="w-full">
                        <label className="text-slate-700 font-medium" htmlFor="name">Your Name</label>
                    ...
                    <div className="w-full">
                        <label className="text-slate-700 font-medium" htmlFor="email">Your Email</label>
                        <div className="relative mt-2">
                ...
                <div className="mt-6 w-full">
                    <label className="text-slate-700 font-medium" htmlFor="message">Message</label>
                    <textarea 
