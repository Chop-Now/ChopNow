                ...
                <div className='mt-10 pb-16 px-6 md:px-16 lg:px-24 xl:px-32'>
                    ...
                    <div className='md:hidden mb-4'>
                        <div className='flex gap-2 relative'>
                            {/* Sliding background */}
                            <div
                                className={`absolute top-0 bottom-0 w-[calc(50%-4px)] bg-green-600 rounded-md transition-transform duration-300 ease-in-out ${selectedDeliveryType === 'Delivery' ? 'transform translate-x-0' : 'transform translate-x-[calc(100%+8px)]'
                                    }`}
                            />
                            <button
                                onClick={() => handleDeliveryTypeChange('Delivery')}
                                className={`flex-1 py-3 px-6 rounded-md text-sm font-medium z-10 transition-colors duration-300 border ${selectedDeliveryType === 'Delivery' ? 'text-white border-green-600' : 'text-gray-700 border-gray-300 bg-white'
                                    }`}
                            >
                                Delivery
                            </button>
                            <button
                                ...
                                className={`flex-1 py-3 px-6 rounded-md text-sm font-medium z-10 transition-colors duration-300 border ${selectedDeliveryType === 'Pickup' ? 'text-white border-green-600' : 'text-gray-700 border-gray-300 bg-white'
                                    }`}
                            >
                                Pickup
                            </button>
                    ...
                    <div className='md:hidden mb-6'>
                        <div className='bg-gray-100 rounded-full p-1 flex relative'>
                            {/* Sliding background */}
                            <div
                                className={`absolute top-1 bottom-1 w-1/3 bg-green-600 rounded-full transition-transform duration-300 ease-in-out ${mobileStatusFilter === 'processing' ? 'transform translate-x-0' :
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-full text-sm font-medium z-10 transition-colors duration-300 ${mobileStatusFilter === 'processing' ? 'text-white' : 'text-gray-700'
                                    }`}
                            >
                                Processing
                            </button>
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-full text-sm font-medium z-10 transition-colors duration-300 ${mobileStatusFilter === 'completed' ? 'text-white' : 'text-gray-700'
                                    }`}
                            >
                                Completed
                            </button>
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-full text-sm font-medium z-10 transition-colors duration-300 ${mobileStatusFilter === 'failed' ? 'text-white' : 'text-gray-700'
                                    }`}
                            >
                                Failed
                            </button>
                                ...
                                {currentOrders.map((order, index) => (
                                    <div key={index} className='border border-gray-200 border-t-0 p-3 bg-white'>
                                        <div className='grid grid-cols-6 gap-3 items-center text-xs'>
                                            ...
                                            <div>
                                                <span className={`text-xs px-3 py-1 rounded-full ${order.status === 'Completed' ? 'bg-green-100 text-green-700' :
                            ...
                            <div className='flex justify-between items-center mt-8 flex-wrap gap-4'>
                                ...
                                <div className='flex gap-2'>
                                    <button
                                        ...
                                        className={`flex items-center gap-1 px-4 py-2 border rounded-md text-sm font-medium transition-colors ${currentPage === 1
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-1 px-4 py-2 border rounded-md text-sm font-medium transition-colors ${currentPage === totalPages
                                                ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                                                : 'bg-white text-gray-700 hover:bg-gray-50'
                                            }`}
                                    >
                                ...
                                <div className='mb-6'>
                                    ...
                                    <div className='grid grid-cols-2 gap-4 text-sm'>
                                        ...
                                        <div>
                                            ...
                                            <p className={`font-medium ${selectedOrder.status === 'Completed' ? 'text-green-700' :
