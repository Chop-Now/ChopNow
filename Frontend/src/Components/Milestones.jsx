...
const Milestones = () => {
  const milestones = [
    {
      image:
        'https://images.unsplash.com/photo-1588497859490-85d1c17db96d?q=80&w=2000&auto=format&fit=crop',
      badge: 'Early 2026',
  ...
  return (
    ...
    >
      ...
      >
        As an early-stage team, these are the impact goals guiding our sprints over the next 12
        months.
      </motion.p>
