                ...
                <div className="flex flex-col gap-3">
                  {['Distance (Nearest First)', 'Date Posted', 'A to Z', 'Vendor Rating'].map((option) => (
                    <button
                      ...
                      className={`text-left px-4 py-3 rounded-lg transition ${sortBy === option ? 'font-semibold' : ''
                        }`}
                      style={{
              ...
              <div className="flex items-center gap-2 text-sm font-medium">
                {getPageNumbers().map((pageNum) => (
                  <button
                    ...
                    className={`h-10 w-10 flex items-center justify-center aspect-square cursor-pointer ${currentPage === pageNum
                        ? 'border rounded-full'
                        : ''
                      }`}
