            ...
            >
                ...
                <div className="flex items-center gap-4 flex-wrap justify-center">
                    ...
                    <div className="w-16 h-16 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center p-2 hover:border-(--color-solid) transition-colors">
                        <img src={assets.momo} alt="MTN Mobile Money" className="w-full h-full object-contain" />
                    </div>
                    
                    {/* Airtel Money */}
                    <div className="w-16 h-16 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center p-2 hover:border-(--color-solid) transition-colors">
                        <img src={assets.airtel_money} alt="Airtel Money" className="w-full h-full object-contain" />
                    </div>
                    ...
                    {/* Mastercard */}
                    <div className="w-16 h-16 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center p-2 hover:border-(--color-solid) transition-colors">
                        <img src={assets.mastercard} alt="Mastercard" className="w-full h-full object-contain" />
                    </div>
